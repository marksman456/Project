...
namespace Project.Migrations
{
    ...
    [Migration("20250918023046_Add_Product_ModelSpec_ManyToMany")]
    partial class Add_Product_ModelSpec_ManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelSpecProduct", b =>
                {
                    b.Property<int>("ProductsProductID")
                        .HasColumnType("int");

                    b.Property<int>("SpecsModelSpecID")
                        .HasColumnType("int");

                    b.HasKey("ProductsProductID", "SpecsModelSpecID");

                    b.HasIndex("SpecsModelSpecID");

                    b.ToTable("ModelSpecProduct");
                });
            ...
            modelBuilder.Entity("ModelSpecProduct", b =>
                {
                    b.HasOne("ProjectData.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectData.Models.ModelSpec", null)
                        .WithMany()
                        .HasForeignKey("SpecsModelSpecID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
