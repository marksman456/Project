...
public partial class XiangYunDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasOne(d => d.Member).WithMany(p => p.Account)
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasMany(d => d.Role).WithMany(p => p.Employee)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("EmployeeID", "RoleID").HasName("PK__Employee__C27FE312BCE697B6");
                    });
        });
        ...
        {
            entity.HasKey(e => e.RoleID).HasName("PK__Role__8AFACE3ACEE4216E");

            entity.HasIndex(e => e.RoleName, "UQ__Role__8A2B6160D9FD0471").IsUnique();
